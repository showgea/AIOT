...
def ifttt_action_query(positionId, size=None, startIndex=None):
    url_ = url + "/app/v1.0/lumi/ifttt/action/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = ifttt_action_query("real1.615940701625851904")
