...
def service_unsubscribe(serviceIds):
    url_ = url + "/app/v1.0/lumi/service/unsubscribe"
    json_ = {
...
if __name__ == '__main__':
    result_main = service_unsubscribe("S01615944318404558848,S01615944318404558848")
