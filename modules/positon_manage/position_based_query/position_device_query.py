...
def position_device_query(positionId, size=None, startIndex=None):
    url_ = url + "/app/v1.0/lumi/position/device/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = position_device_query("real1.611208606918021120", size=None, startIndex=None)
