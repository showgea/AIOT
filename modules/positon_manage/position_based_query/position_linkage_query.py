...
def position_linkage_query(positionId, size=None, startIndex=None):
    url_ = url + "/app/v1.0/lumi/position/linkage/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = position_linkage_query("real1.611208606918021120", size=None, startIndex=None)
