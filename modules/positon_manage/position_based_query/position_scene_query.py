...
def position_scene_query(positionId, size=None, startIndex=None):
    url_ = url + "/app/v1.0/lumi/position/scene/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = position_scene_query("real1.611208606918021120", size=None, startIndex=None)
