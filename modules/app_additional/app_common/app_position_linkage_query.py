...
def app_position_linkage_query(positionId, startIndex=None, size=None):
    url_ = url + "/app/v1.0/lumi/app/position/linkage/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = app_position_linkage_query("real1.615940701625851904")
