...
def app_position_device_query(positionId, startIndex=None, size=None):
    url_ = url + "/app/v1.0/lumi/app/position/device/query"
    params_ = {
...
if __name__ == '__main__':
    result_main = app_position_device_query("real2.615945282455937024")
